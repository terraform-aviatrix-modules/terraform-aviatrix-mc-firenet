...
locals {
  ...
  get_default_firewall_image = !(local.is_aviatrix || var.firewall_image_id != "") #Do not use default image data if module is used to deploy an Aviatrix FQDN gateway or image_id is provided.
