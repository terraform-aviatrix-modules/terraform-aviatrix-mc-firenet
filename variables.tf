...
locals {
  ...
  firewall_images            = local.get_default_firewall_image ? data.aviatrix_firewall_instance_images[0].firewall_images.firewall_images.* : []
  firewall_image_data        = local.get_default_firewall_image ? [for i in local.firewall_images : i if i.firewall_image == var.firewall_image] : null
