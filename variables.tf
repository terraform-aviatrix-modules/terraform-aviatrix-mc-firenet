...
locals {
  ...
  firewall_image_data        = local.get_default_firewall_image ? [for i in data.aviatrix_firewall_instance_images[0].fw_images.firewall_images.* : i if i.firewall_image == var.firewall_image] : null
